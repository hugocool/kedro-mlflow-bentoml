...
# kedro_mlflow_bentoml documentation build
...
from kedro_mlflow_bentoml import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_mlflow_bentoml"
author = "Kedro"
...
htmlhelp_basename = "kedro_mlflow_bentomldoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_mlflow_bentoml.tex",
        "kedro_mlflow_bentoml Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_mlflow_bentoml",
        "Project kedro_mlflow_bentoml codebase.",
        "Nearest-Neighbour",
    )
]
